...
namespace internal
{
    ...
    public:
        ...
        struct IndexRange
        {
            ...
            IndexRange(const iterator &begin, const iterator &end) : begin_(begin), end_(end) {}
    ...
    private:
        ...
        friend size_t trace_event::internal::DoEstimateMemoryUsageForLruCache(const LruCacheType &);
...
using LRUCache = internal::LRUCacheBase<std::pair<KeyType, ValueType>, internal::GetKeyFromKVPair,
...
using HashingLRUCache = internal::LRUCacheBase<std::pair<KeyType, ValueType>,
    internal::GetKeyFromKVPair, internal::HashingLRUCacheKeyIndex<KeyType, KeyHash, KeyEqual>>;
...
using LRUCacheSet = internal::LRUCacheBase<ValueType, std::identity,
...
using HashingLRUCacheSet = internal::LRUCacheBase<ValueType, std::identity,
