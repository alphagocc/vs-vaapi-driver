...
int32_t csi_ai_getframe(int32_t aidev, int32_t aichn, csi_audio_frame_s *frm,
                        csi_aec_frame_s *aecfrm, int32_t timeout);
int32_t csi_ai_releaseframe(int32_t aidev, int32_t aichn,
                            csi_audio_frame_s *frm, csi_aec_frame_s *aecfrm);

int32_t csi_ai_setchnparam(int32_t aidev, int32_t aichn,
                           csi_aichn_frame_s *chnparam);
int32_t csi_ai_getchnparam(int32_t aidev, int32_t aichn,
                           csi_aichn_frame_s *chnparam);

int32_t csi_ai_enableresmp(int32_t aidev, int32_t aichn,
                           csi_audio_sample_rate_e out_sample_rate);
int32_t csi_ai_disableresmp(int32_t aidev, int32_t aichn);

int32_t csi_ai_setvqeattr(int32_t aidev, int32_t aichn, int32_t aochn,
                          int *level);
int32_t csi_ai_getvqeattr(int32_t aidev, int32_t aichn, int *level);

int32_t csi_ai_settalkvqeattr(int32_t aidev, int32_t aichn, int32_t aodev,
                              int32_t aochn, int *level);
...
int32_t csi_ai_queryfilestatus(int32_t aidev, int32_t aichn,
                               csi_audio_file_status_s *filestatus);
...
int32_t csi_ai_enableaecrefframe(int32_t aidev, int32_t aichn, int32_t aodev,
                                 int32_t aochn);
